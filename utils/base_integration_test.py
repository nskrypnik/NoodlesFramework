...
class BaseTest(unittest.TestCase):
    ...
    def open_location(self):
        ...
        """
        try: self.assertEqual(self.test_location, self.selenium.get_location())
        except AssertionError, self.e: 
            self.verificationErrors.append(str(self.e))
    
    def get_text(self):
        try: self.assertEqual(self.locator.split("=")[1],
    ...
    def verify_equal_find_element_by_css_selector_text(self):
        ...
        """
        try: self.assertEqual(self.locator[0], 
    ...
    def is_text_present(self):
        try: self.failUnless(self.selenium.is_text_present(self.locator))
        except AssertionError, self.e: 
            self.verificationErrors.append(str(self.e))
